...
import { afiliadaLoginAction } from "../lib/afiliada.auth.server";

export const action = async ({ request }: ActionFunctionArgs) => {
  return afiliadaLoginAction(request);
};
    ...
    <div style={{ minHeight: "100vh", background: "#111", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "Inter, system-ui, sans-serif" }}>
      <div style={{ background: "#fff", borderRadius: "20px", padding: "48px 40px", width: "100%", maxWidth: "380px" }}>
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
          ...
          <p style={{ margin: 0, color: "#888", fontSize: "14px" }}>Entre com seu código de cupom</p>
        </div>
        <Form method="post">
          <div style={{ marginBottom: "20px" }}>
            ...
            <input
              ...
              autoComplete="off"
              style={{ width: "100%", padding: "13px 14px", border: "1.5px solid #ddd", borderRadius: "10px", fontSize: "16px", boxSizing: "border-box", textTransform: "uppercase", letterSpacing: "2px", fontWeight: "700", textAlign: "center", outline: "none" }}
            />
          </div>
          {data?.erro && (
          ...
          <button
            type="submit"
            style={{ width: "100%", padding: "14px", background: "#00C9A7", color: "#fff", border: "none", borderRadius: "10px", fontWeight: "800", fontSize: "15px", cursor: "pointer", letterSpacing: "0.5px" }}
          >
            Entrar
          </button>
        </Form>
